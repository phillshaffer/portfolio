    ...
    h('div', {className: 'page'},
      ...
      h('main', {style: componentInlineStyle.page__main},
        ...
        h(Section, {backgroundColor: '#ffffff'},
          ...
          h(SectionMediaGallery, {galleryItems: ['Pallette_1@2x.png','Pallette_2@2x.png','Pallette_3@2x.png','Pallette_4@2x.png','Pallette_5@2x.png','Pallette_6@2x.png','Pallette_7@2x.png','Pallette_8@2x.png','Pallette_9@2x.png'], fullWidth: true, galleryItemPadding: '4'}
          ),
          h(SectionContent, null,
        ...
        h(Section, {backgroundColor: '#f5f5f5'},
          ...
          h(SectionMediaGallery, {galleryItems: ['Create_Spot_dialog_with_instruction@2x.png','Create_Spot_dialog_without_instruction@2x.png'], galleryItemPadding: '4'}
          ),
          h(SectionMediaGallery, {galleryItems: ['Create_Spot_dialog_with_hover@2x.png','Create_Spot_dialog_with_focus@2x.png'], galleryItemPadding: '4'}
          ),
          h(SectionMediaGallery, {galleryItems: ['Create_Spot_dialog_with_error@2x.png','Create_Spot_dialog_with_data@2x.png'], galleryItemPadding: '4'}
          )
        )
      )
    )

		...
		h('div', {className: 'page'},
			...
			h('main', {style: componentInlineStyle.page__main},
				...
				h(Section, {backgroundColor: '#ffffff', scrimHeight: '240'},
					...
					h(ContentArea, {width: '736', bottom: '64'},
				...
				h(Section, {backgroundColor: '#ffffff', scrimHeight: '240'},
					h(ContentArea, {width: '736', top: '64', bottom: '64'},
						...
						h(Image, {image: 'WCAG_2.0_AA_Requirement_Heatmap@2x.png', top: '36', bottom: '16'})
					) 
				),
				h(Section, {backgroundColor: '#ffffff', scrimHeight: '240'},
					h(ContentArea, {width: '736', top: '64', bottom: '64'},
						...
						h(Image, {image: 'AdobeXD_Component_Stickersheet.png', top: '36', bottom: '36', targetUrl: 'https://xd.adobe.com/spec/aa9d6b3a-b880-4d15-6439-bf0cdf9f06ac-dcac/'}),
				...
				h(Section, {backgroundColor: '#ffffff'},
					h(ContentArea, {width: '736', top: '64', bottom: '16'},
